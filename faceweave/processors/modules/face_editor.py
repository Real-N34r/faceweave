...
from faceweave import config, content_analyser, face_analyser, face_masker, logger, process_manager, state_manager, wording
from faceweave.common_helper import create_metavar, map_float
...
from faceweave.face_masker import create_face_mask, create_occlusion_mask, create_static_box_mask
...
from faceweave.processors.typing import FaceEditorInputs
from faceweave.program_helper import find_argument_group
from faceweave.thread_helper import thread_lock, thread_semaphore
from faceweave.typing import Args, Face, FaceLandmark68, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		faceweave.jobs.job_store.register_step_keys([ 'face_editor_model','face_editor_eye_open_ratio', 'face_editor_eye_open_factor', 'face_editor_lip_open_ratio', 'face_editor_lip_open_factor' ])
