...
from faceweave import config, process_manager, wording
...
from faceweave.face_helper import warp_face_by_face_landmark_5, categorize_age, categorize_gender
from faceweave.face_store import get_reference_faces
from faceweave.content_analyser import clear_content_analyser
from faceweave.typing import Face, VisionFrame, UpdateProgress, ProcessMode, QueuePayload
from faceweave.vision import read_image, read_static_image, write_image
from faceweave.processors.frame.typings import FaceDebuggerInputs
from faceweave.processors.frame import globals as frame_processors_globals, choices as frame_processors_choices
...
def debug_face(target_face : Face, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	if 'face-mask' in frame_processors_globals.face_debugger_items:
		...
		if 'box' in faceweave.globals.face_mask_types:
			box_mask = create_static_box_mask(crop_vision_frame.shape[:2][::-1], 0, faceweave.globals.face_mask_padding)
