...
from faceweave.face_analyser import get_many_faces, clear_face_analyser, find_similar_faces, get_one_face
from faceweave.face_masker import create_static_box_mask, create_occlusion_mask, clear_face_occluder
...
from faceweave.typing import Face, VisionFrame, UpdateProgress, ProcessMode, ModelSet, OptionsWithModel, QueuePayload
...
from faceweave.processors.frame.typings import FaceEnhancerInputs
...
def enhance_face(target_face: Face, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	box_mask = create_static_box_mask(crop_vision_frame.shape[:2][::-1], faceweave.globals.face_mask_blur, (0, 0, 0, 0))
	crop_mask_list =\
	[
		box_mask
	]
