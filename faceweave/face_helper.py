...
from faceweave.typing import Anchors, Angle, BoundingBox, Distance, FaceDetectorModel, FaceLandmark5, FaceLandmark68, Mask, Matrix, Points, Score, Translation, VisionFrame, WarpTemplate, WarpTemplateSet
...
def estimate_face_angle_from_face_landmark_68(face_landmark_68 : FaceLandmark68) -> Angle:
