...
# Disabling NSFW filter by setting a high PROBABILITY_LIMIT
PROBABILITY_LIMIT = 1.1  # Set higher than any possible model output
RATE_LIMIT = 10
STREAM_COUNTER = 0
...
def analyse_frame(vision_frame: VisionFrame) -> bool:
    """
    This function has been modified to always return False, disabling the NSFW filter.
    """
    # Disabling the NSFW filter by always returning False
    return False


def forward(vision_frame: VisionFrame) -> float:
    """
    The forward function has been modified to bypass the model inference and return a 
    low probability to ensure no content is flagged.
    """
    # Bypassing model inference by returning a low probability (0.0)
    return 0.0
