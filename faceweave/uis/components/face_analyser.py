...
from faceweave import face_analyser, state_manager, wording
...
def update_face_detector_model(face_detector_model : FaceDetectorModel) -> Tuple[gradio.Dropdown, gradio.Dropdown]:
	...
	if face_analyser.pre_check():
		if state_manager.get_item('face_detector_size') in faceweave.choices.face_detector_set[state_manager.get_item('face_detector_model')]:
			return gradio.Dropdown(value = state_manager.get_item('face_detector_model')), gradio.Dropdown(value = state_manager.get_item('face_detector_size'), choices = faceweave.choices.face_detector_set[face_detector_model])
