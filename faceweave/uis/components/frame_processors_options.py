...
from faceweave.processors.frame.typings import FaceDebuggerItem, FaceEnhancerModel, FaceSwapperModel, FrameColorizerModel, FrameEnhancerModel, LipSyncerModel
...
def render() -> None:
	...
	FACE_DEBUGGER_ITEMS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		visible = 'face_debugger' in faceweave.globals.frame_processors
	)
	FACE_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_enhancer' in faceweave.globals.frame_processors
	)
	...
	FACE_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_swapper' in faceweave.globals.frame_processors
	)
	FRAME_COLORIZER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'frame_colorizer' in faceweave.globals.frame_processors
	)
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'frame_enhancer' in faceweave.globals.frame_processors
	)
	...
	LIP_SYNCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'lip_syncer' in faceweave.globals.frame_processors
	)
