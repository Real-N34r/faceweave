...
from faceweave import process_manager, wording
from faceweave.face_store import clear_static_faces
from faceweave.processors.frame.core import get_frame_processors_modules
from faceweave.vision import count_video_frame_total, detect_video_resolution, detect_video_fps, pack_resolution
from faceweave.core import conditional_process
from faceweave.memory import limit_system_memory
from faceweave.filesystem import clear_temp
...
def start(benchmark_runs : List[str], benchmark_cycles : int) -> Generator[List[Any], None, None]:
	faceweave.globals.source_paths = [ '.assets/examples/source.jpg', '.assets/examples/source.mp3' ]
	faceweave.globals.output_path = tempfile.gettempdir()
	faceweave.globals.face_landmarker_score = 0
	faceweave.globals.temp_frame_format = 'bmp'
	faceweave.globals.output_video_preset = 'ultrafast'
	benchmark_results = []
	...
	if target_paths:
		...
		for target_path in target_paths:
			faceweave.globals.target_path = target_path
